describe('pingPong', function() {
  ...
  it("it will give replace numbers divisble by 15 from a user number with the word ping-pong", function() {
    expect(pingPong(60)).to.eql("ping-pong");
  });
  it("it will give replace numbers divisble by 5 from a user number with the word pong", function() {
